...
const CATEGORIES: CategoryMeta[] = [
  { id: "getting-started", label: "Getting Started", icon: Zap, description: "New to VidyaBolt? Start here." },
 ...
 *
 * Comprehensive Q&A covering all aspects of the VidyaBolt platform.
 * Each item has a unique ID for anchor linking and analytics tracking.
 * ───────────────────────────────────────────── */
const FAQ_DATA: FAQItem[] = [
  /* ── Getting Started ── */
  {
    id: "what-is-vidyabolt",
    question: "What is VidyaBolt?",
    answer: "VidyaBolt is a gamified education platform designed for Indian students in Class 9-12 and Engineering. It combines structured NCERT-aligned academic content, 12+ programming language tracks, real-time quiz battles, and a full XP/leveling system to make daily study genuinely rewarding. Think of it as a learning RPG where your character levels up by mastering real subjects.",
    category: "getting-started",
  },
  {
    id: "how-to-sign-up",
    question: "How do I create an account?",
    answer: "Visit vidyabolt.in/sign-up and enter your name, email, and password. You will be asked to select your class level (9-12 or Engineering) and stream (Science, Commerce, Arts). Account creation is completely free and takes less than 60 seconds. You will receive 100 starter Stars in your wallet immediately.",
    category: "getting-started",
  },
  {
    id: "what-is-free",
    question: "Is VidyaBolt really free?",
  ...
  {
    id: "who-is-it-for",
    question: "Who is VidyaBolt built for?",
    answer: "VidyaBolt serves three main groups: (1) Class 9-12 CBSE/ICSE students who need structured, day-wise study plans for board exam preparation, (2) Engineering students learning programming languages and Data Structures, and (3) Competitive exam aspirants (JEE, NEET preparation tracks coming soon). Parents and teachers can also use the platform to monitor student progress.",
    category: "getting-started",
  },
  {
    id: "platforms-supported",
    question: "What devices can I use VidyaBolt on?",
    answer: "VidyaBolt is a fully responsive web application that works on any device with a modern web browser — desktops, laptops, tablets, and smartphones. We support Chrome, Firefox, Safari, and Edge. A native mobile app (iOS and Android) is planned for the next major release.",
    category: "getting-started",
  },
  ...
  {
    id: "board-exams",
    question: "Does VidyaBolt help with board exam preparation?",
  ...
  /* ── Engineering & Coding ── */
  {
    ...
    answer: "VidyaBolt offers structured learning plans for 12+ languages: C, C++, Python, Java, JavaScript, TypeScript, Go, Rust, Ruby, Swift, Kotlin, and SQL. Each language has a complete curriculum from basics to advanced topics, with hands-on coding problems and real-world project ideas. Additional languages (PHP, Scala, Dart) are in development.",
  ...
  },
  {
    ...
    answer: "A streak is the number of consecutive days you have used VidyaBolt for active learning (completing at least one lesson or practice session). Streaks are a powerful motivation tool — they are displayed on your profile, the dashboard, and the leaderboard. Maintaining a streak earns bonus XP. If you miss a day, your streak resets to zero, but your highest streak is always preserved.",
    category: "battles",
  },
  {
    id: "leaderboard",
    question: "How does the leaderboard work?",
    answer: "VidyaBolt has multiple leaderboard views: Global (all users), Class-specific (your class level), Weekly (resets every Monday), and Battle (ranked by win rate). Rankings are based on XP. The top 10 users receive special badges and Stars rewards. The leaderboard is updated in real-time as users earn XP.",
    category: "battles",
  },
  {
    id: "stars-wallet",
  ...
  },
  {
    ...
    answer: "VidyaBolt takes data security seriously. Passwords are hashed with PBKDF2-SHA512 (100,000 iterations). Sessions use httpOnly cookies. All communication is encrypted via HTTPS. We do not sell user data to third parties. We follow GDPR-inspired data handling practices and will comply with India's DPDP Act requirements.",
    category: "account",
  },
  {
    id: "change-class",
  ...
  },
  {
    ...
    answer: "School Partner pricing is customized based on the number of students, required features, and deployment needs. It includes teacher dashboards, bulk enrollment, school-wide analytics, and dedicated support. Contact us at support@vidyabolt.in or visit /contact for a custom quote.",
    category: "billing",
  },
  ...
  /* ── Community ── */
  {
    ...
    answer: "VidyaBolt has chapter-specific and general discussion forums where students can ask doubts, share study tips, and help each other. You can create posts, comment on others' posts, and upvote helpful content. Forum participation earns XP. Moderators ensure discussions stay respectful and on-topic.",
    category: "community",
  },
  {
    id: "hackathons",
    question: "What are VidyaBolt Hackathons?",
    answer: "We host periodic hackathons — coding competitions where students solve real-world problems in teams. Hackathons have themes (e.g., health tech, education tools, sustainability), time limits (24-48 hours), and prizes (Stars, premium badges, certificates). Registration is free and open to all VidyaBolt users.",
    category: "community",
  },
  {
    id: "events",
    question: "What events does VidyaBolt host?",
    answer: "VidyaBolt hosts weekly quiz tournaments, monthly coding challenges, seasonal hackathons, and special board exam preparation workshops. All events are free to join and visible on the Events page. Winners earn Stars, XP, and exclusive profile badges. Past events and their results are archived for reference.",
    category: "community",
  },
  ...
  /* ── Technical ── */
  {
    ...
    answer: "VidyaBolt works best on the latest versions of Google Chrome, Mozilla Firefox, Apple Safari, and Microsoft Edge. We recommend Chrome for the best experience. Internet Explorer is not supported. JavaScript must be enabled.",
    category: "technical",
  },
  {
    id: "offline-access",
    question: "Can I use VidyaBolt offline?",
    answer: "Currently, VidyaBolt requires an active internet connection. Offline access (downloadable lessons and practice sets) is a planned Pro feature. We will implement Progressive Web App (PWA) capabilities to enable limited offline functionality.",
    category: "technical",
  },
  {
    id: "report-bug",
    question: "How do I report a bug?",
    answer: "If you find a bug, please report it through the Contact page (/contact) or email us at support@vidyabolt.in. Include: (1) What you were doing, (2) What you expected to happen, (3) What actually happened, (4) Your browser and device. Screenshots are very helpful. We triage all bug reports within 24 hours.",
    category: "technical",
  },
  {
    id: "api-access",
    question: "Does VidyaBolt have a public API?",
    answer: "Yes. VidyaBolt exposes a RESTful API at /api with endpoints for content, progress, battles, leaderboards, and more. The API is documented at /api (root endpoint). Public API access for third-party integrations (School Partner plan) is planned for launch alongside the Pro plan.",
    category: "technical",
  },
];
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          ...
          <p className={styles.heroSubtitle}>
            Everything you need to know about VidyaBolt — from getting started to
