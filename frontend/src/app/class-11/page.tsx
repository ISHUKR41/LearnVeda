...
export const metadata = {
  title: "CBSE Class 11 Science Commerce Arts — Zingpath by Ishu | Free",
  description:
    "Zingpath by Ishu — Best free CBSE Class 11 study platform. Science (Physics, Chemistry, Biology, Maths), Commerce (Accountancy, Business), Arts streams. Chapter-wise plans, XP, quiz battles. India's #1 Class 11 gamified learning platform.",
  keywords: [
    ...
    "Zingpath class 11", "ishu class 11", "best class 11 website India",
  ...
  openGraph: {
    title: "CBSE Class 11 — Zingpath by Ishu | Free Gamified Study",
...
/* ─────────────────────────────────────────────
 * WHY_CARDS — reasons to choose Zingpath for Class 11
 * ───────────────────────────────────────────── */
const WHY_CARDS = [
  {
    icon: BookOpen,
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.whySection}>
          <div className={styles.whySectionHeader}>
            <h2 className={styles.sectionTitle}>Why Zingpath for Class 11?</h2>
          </div>
