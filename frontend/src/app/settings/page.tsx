...
/**
 * All five Learnova learning tracks with display names and brand colours.
        ...
        <SettingsSection title="Security" icon={Shield} accent="#7C3AED">
          <form onSubmit={handleChangePassword} className={styles.form} noValidate>
            ...
            <div className={styles.securityNote}>
              <Info size={14} />
              Your password is hashed with argon2id — Learnova never stores plain-text passwords.
            </div>
          ...
          <div className={styles.accountActions}>
            ...
            <div className={styles.dangerZone}>
              ...
              <p className={styles.dangerZoneDesc}>
                ...
                be recovered. Contact <strong>support@learnova.in</strong> if you need help instead.
              </p>
              <button
                className={styles.dangerBtn}
                onClick={() =>
                  toast.error(
                    "To delete your account please email support@learnova.in with subject: Account Deletion Request",
                    { duration: 6000 }
                  )
                }
              >
