...
export default function NotesCatalogPage() {
  ...
  const catalogSchema = generateCourseSchema({
    name: "EduQuest Academic Lecture Notes & Study Syllabus",
    ...
    providerName: "EduQuest Board of CSE Studies"
  });
    ...
    <>
      ...
      <main className={styles.container}>
        ...
        <section className={styles.studyFeatures}>
          <h3 className={styles.featuresTitle}>Why Study on EduQuest Knowledge Hub?</h3>
