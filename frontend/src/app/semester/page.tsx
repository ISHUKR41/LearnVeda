...
export default function SemesterCatalogPage() {
  ...
  const catalogSchema = generateCourseSchema({
    name: "EduQuest BTech CSE Semester Exam Blueprints & Survival Guides",
    ...
    providerName: "EduQuest Academic Affairs Office"
  });
    ...
    <>
      ...
      <main className={styles.container}>
        ...
        <section className={styles.featuresSection}>
          <h3 className={styles.featuresTitle}>Why Trust EduQuest Blueprints?</h3>
