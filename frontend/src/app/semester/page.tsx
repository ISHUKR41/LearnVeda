...
export default function SemesterCatalogPage() {
  ...
  const catalogSchema = generateCourseSchema({
    name: "VidyaBolt BTech CSE Semester Exam Blueprints & Survival Guides",
    ...
    providerName: "VidyaBolt Academic Affairs Office"
  });
    ...
    <>
      ...
      <main className={styles.container}>
        ...
        <section className={styles.featuresSection}>
          <h3 className={styles.featuresTitle}>Why Trust VidyaBolt Blueprints?</h3>
