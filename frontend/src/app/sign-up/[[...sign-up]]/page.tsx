 ...
 *          Zingpath benefits; right panel renders Clerk's <SignUp> component.
...
export const metadata = {
  title: "Create Account — Zingpath",
  description: "Join thousands of Indian students on Zingpath. Study smarter with gamified learning, XP, streaks, and live quiz battles.",
};

/* Clerk component appearance — matches Zingpath dark design system.
