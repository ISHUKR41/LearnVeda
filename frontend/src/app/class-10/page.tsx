...
export const metadata = {
  title: "CBSE Class 10 Board Exam Prep — Zingpath by Ishu | Free Online",
  description:
    "Zingpath by Ishu — Best free CBSE Class 10 board exam preparation platform. Maths Standard & Basic, Science, Social Science, English, Hindi. Chapter-wise day plans, mock tests, XP, quiz battles. India's #1 Class 10 gamified study platform.",
  keywords: [
    ...
    "Zingpath class 10", "ishu class 10", "best class 10 website India",
  ...
  openGraph: {
    title: "CBSE Class 10 Board Prep — Zingpath by Ishu | Free Gamified",
...
/* ─────────────────────────────────────────────
 * WHY_CARDS Array
 * Four reasons why a Class 10 student should use Zingpath.
 * ───────────────────────────────────────────── */
const WHY_CARDS = [
  {
    icon: Target,
    ...
    <div className={styles.page}>
      <div className={styles.inner}>
        ...
        <div className={styles.whySection}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>Why Zingpath for Class 10?</h2>
            <p className={styles.sectionSubtitle}>
              Board exams reward consistency and strategy. Zingpath provides both.
            </p>
          </div>
