...
export const metadata: Metadata = {
  title: 'Lenses & Human Eye – Class 10 Physics | Ishu Website | Lens Formula, Power, Eye Defects | LearnVeda',
  description:
  ...
  keywords: [
    ...
    'LearnVeda class 10 physics', '#1 class 10 lenses notes',
  ],
  ...
  openGraph: {
    type: 'article',
    title: 'Lenses & Human Eye – Class 10 Physics | Ishu Website | LearnVeda',
    description:
  ...
  twitter: {
    ...
    title: 'Lenses & Human Eye – Class 10 | Ishu Website | LearnVeda',
