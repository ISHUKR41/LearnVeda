...
export const metadata: Metadata = {
  title: 'Light Reflection & Refraction – Chapter Summary | Quick Revision Class 10 | Learnova',
  description:
  ...
  openGraph: {
    type: 'article',
    title: 'Light Reflection & Refraction – Complete Summary | Class 10 Revision | Learnova',
    description:
  ...
  twitter: {
    ...
    title: 'Light Chapter Summary – Class 10 Quick Revision | Learnova',
...
const jsonLd = {
  ...
  inLanguage: 'en-IN',
  provider: { '@type': 'EducationalOrganization', name: 'Learnova', url: BASE },
  isPartOf: {
    '@type': 'Course',
