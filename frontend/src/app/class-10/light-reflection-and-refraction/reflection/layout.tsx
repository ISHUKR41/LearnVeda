...
export const metadata: Metadata = {
  title: 'Reflection of Light – Class 10 Physics | Ishu Website | Mirror Formula, Ray Diagrams | Zingpath',
  description:
  ...
  keywords: [
    ...
    'Zingpath class 10 physics', '#1 class 10 physics website',
