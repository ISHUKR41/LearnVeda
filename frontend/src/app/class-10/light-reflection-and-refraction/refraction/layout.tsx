...
export const metadata: Metadata = {
  title: "Refraction of Light – Class 10 Physics | Ishu Website | Snell's Law, TIR, Optical Fibre | EduQuest",
  description:
  ...
  keywords: [
    ...
    'interactive refraction simulation', 'EduQuest class 10 physics',
