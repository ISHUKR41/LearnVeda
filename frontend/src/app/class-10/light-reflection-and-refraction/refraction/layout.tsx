...
export const metadata: Metadata = {
  title: "Refraction of Light – Class 10 Physics | Ishu Website | Snell's Law, TIR, Optical Fibre | Zingpath",
  description:
  ...
  keywords: [
    ...
    'interactive refraction simulation', 'Zingpath class 10 physics',
