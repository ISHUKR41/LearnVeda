...
export const metadata: Metadata = {
  ...
  title: 'Light – Reflection and Refraction | Ishu Website | Class 10 Science CBSE | VidyaBolt',
  description:
  ...
  keywords: [
    ...
    'VidyaBolt class 10', 'VidyaBolt by Ishu', '#1 ishu physics website',
  ],
  ...
  openGraph: {
    type: 'website',
    title: 'Light – Reflection and Refraction | Ishu Website | Class 10 CBSE | VidyaBolt',
...
const webPageJsonLd = {
  ...
  url: `${BASE}/class-10/light-reflection-and-refraction`,
  inLanguage: 'en-IN',
  isPartOf: { '@type': 'WebSite', name: 'VidyaBolt by Ishu', url: BASE },
