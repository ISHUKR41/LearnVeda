 ...
 * PURPOSE: Professional pricing page for Zingpath. Shows three clear tiers —
...
export const metadata = {
  title: "Pricing — Zingpath by Ishu | Free for All Indian Students",
  description:
    "Zingpath by Ishu is 100% free for all Indian students. CBSE Class 9-12, Engineering, JEE, NEET — all chapters, quiz battles, XP, leaderboard. No hidden charges. India's #1 free gamified learning platform.",
  keywords: [
    "Zingpath pricing", "Zingpath free", "free education platform India",
  ...
  openGraph: {
    title: "Pricing — Zingpath by Ishu | 100% Free for Indian Students",
    description: "Zingpath by Ishu is completely free. All CBSE classes, JEE, NEET, Engineering. No hidden charges.",
    type: "website",
  },
};
...
const PRICING_PLANS = [
  ...
  },
  {
    ...
    description: "Complete Zingpath deployment for schools with teacher dashboards and bulk enrollment.",
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          ...
          <p className={styles.heroSubtitle}>
            Every core Zingpath feature is free forever — class tracks, battles, streaks, leaderboard.
      ...
      <section className={styles.trustSection}>
        <div className={styles.trustInner}>
          ...
          <div className={styles.finalCta}>
            ...
            <p>Join thousands of students already using Zingpath — completely free.</p>
