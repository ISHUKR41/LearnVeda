 ...
 * PURPOSE: Comprehensive, professional Terms of Service for EduQuest.
...
export const metadata = {
  ...
  description:
    "EduQuest Terms of Service — covering eligibility, account security, learning integrity, battle rules, community conduct, intellectual property, disclaimers, and governing law (India).",
};
...
const TERM_CARDS = [
  {
    ...
    body: "You are responsible for keeping your account credentials private. Do not share login details or allow others to use your account. Sign out from shared or public devices after every session. Suspicious activity should be reported immediately to support@eduquest.in.",
  },
  {
    icon: BookOpenCheck,
...
const DETAIL_SECTIONS = [
  {
    ...
    body: "EduQuest is designed for students aged 14 and above (Class 9 and higher). Users under 18 must have parental or guardian consent. By creating an account, you represent that you meet the age requirement or that a parent/guardian has approved your use. EduQuest reserves the right to request verification and to suspend accounts that do not comply.",
  },
  {
    icon: LockKeyhole,
    title: "Authentication & Protected Access",
    body: "Certain features — dashboards, wallets, battle arenas, achievements, and community posting — require a valid Clerk authentication session. If your session expires, EduQuest will prompt you to sign in again. Attempting to access protected API routes without authentication or to forge session tokens is a violation of these Terms and applicable law.",
  },
  {
    icon: Medal,
    title: "XP, Levels, Streaks & Rewards",
    body: "Gamification values (XP, levels, streaks, stars, ranks, battle records) are learning progress indicators — they hold no real-world monetary value, are non-transferable, and cannot be exchanged for cash. EduQuest may correct, adjust, or reset these values if errors, duplicate submissions, bugs, or policy violations result in inaccurate data.",
  },
  {
    icon: CircleAlert,
    title: "Acceptable Use Policy",
    body: "You agree not to: scrape or harvest content from EduQuest without written permission, send spam through the Contact or Community features, attack authentication flows or attempt SQL injection, reverse-engineer the platform, automate answers to artificially inflate scores, or use EduQuest in any manner that harms other users or disrupts platform operations.",
  },
  {
    icon: FileText,
    title: "Intellectual Property",
    body: "All EduQuest content — including chapter notes, practice questions, simulation code, UI designs, brand assets, and platform software — is owned by EduQuest or its licensors. Students retain ownership of their answers and community posts. You may use EduQuest content solely for personal, non-commercial learning purposes. Reproducing or redistributing EduQuest content without permission is prohibited.",
  },
  {
    icon: Sparkles,
    title: "Community & User Content",
    body: "When you post in community forums, you grant EduQuest a non-exclusive, royalty-free licence to display that content on the platform. You are responsible for ensuring your posts do not infringe third-party intellectual property, contain false information, or violate these Terms. EduQuest may remove content that violates community standards without prior notice.",
  },
  {
    icon: Scale,
    title: "Disclaimers of Warranties",
    body: "EduQuest is provided 'as is' and 'as available' without warranties of any kind, express or implied. We do not warrant that the platform will be error-free, uninterrupted, or free of viruses. Educational content is aligned to CBSE/NCERT syllabi to the best of our knowledge but should be verified against official textbooks for board examinations.",
  },
  {
    icon: CircleAlert,
    title: "Limitation of Liability",
    body: "To the maximum extent permitted by Indian law, EduQuest's aggregate liability for any claim arising from your use of the platform is limited to INR 1,000 or the amount you paid EduQuest in the 12 months preceding the claim, whichever is lower. EduQuest is not liable for indirect, consequential, or punitive damages of any kind.",
  },
  {
    icon: Scale,
    title: "Platform Changes & Availability",
    body: "Features, simulations, practice questions, dashboards, and reward structures may evolve as EduQuest improves. We aim to preserve genuine learning progress when systems are updated. Planned maintenance will be communicated in advance where possible. EduQuest does not guarantee uninterrupted availability and is not liable for temporary outages.",
  },
  {
    icon: FileText,
    title: "Governing Law & Dispute Resolution",
    body: "These Terms are governed by the laws of India. Any disputes arising from your use of EduQuest shall first be attempted to be resolved amicably through our support team. If unresolved within 30 days, disputes shall be subject to the exclusive jurisdiction of the courts in New Delhi, India. For consumer disputes, you may also approach the Consumer Disputes Redressal Commission.",
  },
];
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <p>
          EduQuest is a learning platform built for structured study, physics simulations,
          ...
          EduQuest, you agree to these terms.
        </p>
      </section>
      ...
      <section className={styles.statusBand} aria-label="Terms summary">
        ...
        <div>
          ...
          <span>
            Use EduQuest for genuine academic study, respectful peer competition,
      ...
      <section className={styles.notice}>
        ...
        <p>
          EduQuest may update these Terms as the platform evolves. Material changes
          will be communicated via dashboard notification or email at least 7 days before
          taking effect. Continued use of EduQuest after the effective date constitutes
          acceptance of the updated Terms.
          <br /><br />
          For questions about these Terms, contact us at{" "}
          <a href="mailto:legal@eduquest.in" style={{ color: "var(--color-primary)" }}>
            legal@eduquest.in
          </a>{" "}
          or visit the{" "}
