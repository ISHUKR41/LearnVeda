 ...
 * LOCATION: src/app/class-12/[stream]/[subject]/[chapter]/ChapterPracticeClient.tsx
 * PURPOSE: Interactive client-side quiz engine for Class 12 Chapter Practice.
 *          Renders MCQ options, provides feedback on submission, updates XP points,
 *          and shows a completion summary.
 * USED BY: src/app/class-12/[stream]/[subject]/[chapter]/page.tsx
 * DEPENDENCIES: React, CSS modules, Next.js navigation components
 * LAST UPDATED: 2026-05-20
 * AUTHOR NOTE: Fully self-contained interactive component with high-end animations and premium visuals tailored for Class 12.
 */
