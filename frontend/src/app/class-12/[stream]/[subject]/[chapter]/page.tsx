/**
 * FILE: page.tsx
 * LOCATION: src/app/class-12/[stream]/[subject]/[chapter]/page.tsx
 * PURPOSE: Server-side page route handler for Class 12 Chapter Practice.
...
export default async function Class12ChapterPracticePage({ params }: PageProps) {
  ...
  const backUrl = `/class-12/${params.stream}/${params.subject}`;
