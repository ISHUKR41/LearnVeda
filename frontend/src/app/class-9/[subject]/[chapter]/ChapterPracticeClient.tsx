 ...
 * LOCATION: src/app/class-9/[subject]/[chapter]/ChapterPracticeClient.tsx
 * PURPOSE: Interactive client-side quiz engine for Class 9 Chapter Practice.
 *          Renders MCQ options, provides feedback on submission, updates XP points,
 *          and shows a completion summary.
 * USED BY: src/app/class-9/[subject]/[chapter]/page.tsx
 * DEPENDENCIES: React, CSS modules, Next.js navigation components
 * LAST UPDATED: 2026-05-20
 * AUTHOR NOTE: Fully self-contained interactive component with high-end animations and premium visuals.
 */
...
export default function ChapterPracticeClient({ snapshot, backUrl }: ChapterPracticeClientProps) {
  ...
  const handleSubmit = () => {
    ...
    if (correct) {
      ...
      // Gamified XP rewards: more points for first attempt correct!
  ...
  const handleRetryQuestion = () => {
    // Allows user to try answering again if incorrect
    const questionId = currentQuestion.id;
