...
export const metadata = {
  title: "CBSE Class 9 Study Platform — Zingpath by Ishu | Free Online Learning",
  description:
    "Zingpath by Ishu — Best free CBSE Class 9 study platform. Mathematics, Science, Social Science, English, Hindi, Computer, AI. Chapter-wise day plans, XP streaks, quiz battles. India's #1 gamified Class 9 learning platform.",
  keywords: [
    ...
    "Zingpath class 9", "ishu class 9", "best class 9 website India",
  ...
  openGraph: {
    title: "CBSE Class 9 — Zingpath by Ishu | Free Gamified Learning",
