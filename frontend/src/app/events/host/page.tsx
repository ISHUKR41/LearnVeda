 ...
 * PURPOSE: Application form for colleges and institutions to host an event on Learnova.
 ...
 *          success confirmation. The Learnova team reviews applications within 48 hours.
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: "Hosting on Learnova is free for educational institutions. Large corporate events may involve a platform partnership fee — discussed after review.",
  },
  {
    ...
    <div className={styles.page}>
      ...
      <div className={styles.hero}>
        ...
        <h1 className={styles.heroTitle}>
          Host your next competition on Learnova
        </h1>
          ...
          {submitted ? (
            <div className={styles.successCard}>
              ...
              <p className={styles.successText}>
                Thank you for applying to host an event on Learnova. Our team will
            ...
            <form onSubmit={handleSubmit(onSubmit)} noValidate>
              ...
              <label className={styles.checkboxItem}>
                ...
                />
                <span className={styles.checkboxLabel}>
                  <strong>I agree to Learnova&apos;s Event Hosting Terms</strong>
