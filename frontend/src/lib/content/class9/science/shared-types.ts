 ...
 * LOCATION: src/lib/content/class9/science/shared-types.ts
 * PURPOSE: Shared TypeScript interfaces for ALL Class 9 Science chapter content.
 *          Every chapter (Matter, Motion, Force, Gravitation, etc.) imports
 *          Question, Topic, and Chapter from this single source of truth.
 *          Keeping types centralised prevents drift between chapter modules.
 * USED BY: Every chapter content folder under class9/science/
...
export interface Topic {
   ...
   */
  content: string;
  /** 20 questions — 5 MCQ + 5 short + 5 long + 5 HOTS */
  questions: Question[];
...
export interface Chapter {
  /** URL-safe slug — must match the catalog slug (e.g. "matter-in-our-surroundings") */
  id: string;
  ...
  class: string;
  /** NCERT chapter number (1–15 for Class 9 Science) — optional for legacy chapters */
