...
export const CLASSES_SIMPLE = [
  {
    ...
    subjects: [
      ...
      { id: "science", name: "Science", chapters: 14 },
      { id: "social-science", name: "Social Science", chapters: 20 },
      { id: "english", name: "English", chapters: 12 },
      { id: "hindi", name: "Hindi", chapters: 12 },
      { id: "sanskrit", name: "Sanskrit", chapters: 10 },
      { id: "information-technology", name: "Information Technology (IT)", chapters: 8 },
      { id: "artificial-intelligence", name: "Artificial Intelligence (AI)", chapters: 8 },
      { id: "computer-applications", name: "Computer Applications", chapters: 8 },
      { id: "physical-education", name: "Physical Education", chapters: 6 },
      { id: "art-education", name: "Art Education", chapters: 5 },
      { id: "work-education", name: "Work Education", chapters: 5 },
      { id: "health-physical-activity", name: "Health & Physical Activity", chapters: 5 },
    ],
  },
  {
