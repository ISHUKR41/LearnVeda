...
/* === Semester 1 === */
INSERT INTO subjects (name, slug, description, icon, color, class_level, stream, semester, is_published, order_index)
VALUES
...
INSERT INTO chapters (name, slug, description, subject_id, order_index, is_published, total_topics)
SELECT
  ch.name, ch.slug, ch.description,
  s.id, ch.order_idx, true, ch.topics
FROM subjects s,
(VALUES
