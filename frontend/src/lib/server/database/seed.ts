 ...
 * PURPOSE: Seeds the VidyaBolt PostgreSQL database with local/staging demo data.
...
const DEMO_USERS = [
  ...
  { id: "11111111-1111-1111-1111-111111111111", name: "Admin Ops",        email: "admin@vidyabolt.in", track: "engineering", level: 12, xp: 15200, streak: 120, role: "admin" },
];
...
const DEMO_POSTS = [
  {
    ...
    title: "How I cracked JEE Mains with VidyaBolt's 60-day plan",
  ...
  },
  {
    ...
    body: "Started with absolutely zero knowledge of data structures. The VidyaBolt DSA plan takes you from arrays and linked lists all the way to graphs and dynamic programming. The battle arena for DSA problems is a game changer.",
  ...
  },
  {
    ...
    body: "Speed matters, but accuracy matters more. In VidyaBolt battles each correct answer is worth more. Skip questions you're unsure about, come back at the end.",
  ...
  },
  {
    ...
    body: "C++ has a reputation for being difficult but the VidyaBolt plan breaks it into very manageable daily tasks. Week 1 is syntax, Week 2 is functions and arrays, Week 3 is OOP basics.",
  ...
  },
  {
    ...
    title: "My first week on VidyaBolt — honest review",
...
const DEMO_EVENTS = [
  ...
  },
  {
    ...
    description: "1v1 battle format across 64 participants. Single elimination, DSA medium difficulty. Prize: VidyaBolt Pro 6 months.",
...
async function seed(): Promise<void> {
  ...
  console.log("VidyaBolt seed: starting…");
  ...
  console.log("VidyaBolt seed: completed successfully.");
}

seed()
  .catch((err) => {
    console.error("VidyaBolt seed failed:", err);
    process.exitCode = 1;
  })
  .finally(async () => {
