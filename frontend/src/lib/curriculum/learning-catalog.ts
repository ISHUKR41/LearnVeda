...
const CLASS_10_SUBJECTS: Record<string, Omit<LearningPlan, "slug" | "backHref">> = {
  ...
  "science": { title: "Science", eyebrow: "Class 10", description: "Chemistry, physics, and biology revision mapped to board-style practice.", durationDays: 50, accent: "#059669", chapters: ["Chemical Reactions", "Acids Bases Salts", "Life Processes", "Electricity", { slug: "light-reflection-and-refraction", name: "Light: Reflection and Refraction", description: "Reflection, refraction, mirrors, lenses, TIR, prisms, human eye — full NCERT Chapter 10.", dayCount: 9, questionCount: 450, difficulty: "hard" }, "Environment"] },
